...
![메인페이지](https://github.com/Kimsu10/2nd-FE-GabozaGO/assets/107941176/542f266b-0125-4b41-bd9e-a298264cd428)
...
![상품상세](https://github.com/Kimsu10/2nd-FE-GabozaGO/assets/107941176/fb54e53f-716c-44f3-bd3b-b4af6b2a06ed)

1. FE 
    1. 상품 상세정보페이지 레이아웃
        1. 백에서 받아온 데이터를 함수를 사용하여 보여줄 내용만 보여주도록 자르고 배치함. 
        
    2. 찜버튼, 에약하기버튼
        1. 찜버튼 클릭시 짐페이지에 등록되고 다시 찜 클릭시 해제.
        2. 예약하기 버튼 클릭시 달력과 예약페이지가 모달창으로 나타나도록 구현.
    3. 상품 관련 리뷰 리스트 불러오기
    4. 리뷰작성
        1. 리뷰작성시 별점을 다양한곳에서 사용할 수 있도록 hook으로 분리하여 작성.
...
![예약구매](https://github.com/Kimsu10/2nd-FE-GabozaGO/assets/107941176/f3cf36b3-df01-41e5-91b3-1801901e42d8)
...
1. FE 
    ...
    2. 날짜와 이원수의 조건이 맞으면 결제수단을 선택하는 모달창을 띄움
        1. 포인트결제
            1. 보유포인트가 있을경우 포인트가 부족하다는 알림을 띄우고 다음 절차로 진행할 수 없도록 함.
...
![마이페이지 ](https://github.com/Kimsu10/2nd-FE-GabozaGO/assets/107941176/13ed1665-5bcd-4802-a520-590072ee39be)
